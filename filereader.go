...
// FileReader is the read-only view of a file that File and MemFile implement.
//
// Methods that transfer content take a context for cancellation,
// metadata and open methods don't (see the package documentation).
